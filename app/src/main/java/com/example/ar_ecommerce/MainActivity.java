                ...
                if (snapshot != null && snapshot.exists()) {
                    if (userUsername != null) {
                        ...
                        if (userSnapshot.exists()) {
                            ...
                            contactFromDB = userSnapshot.child("contact").getValue(String.class);
                            birthdateFromDB = userSnapshot.child("birthdate").getValue(String.class);
                        } else {
                            // Handle the case when the user data does not exist
                            Toast.makeText(MainActivity.this, "User data not found", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        // Handle the case when userUsername is null
                        Toast.makeText(MainActivity.this, "Username is null", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    // Handle the case when the snapshot is null or doesn't exist
                    Toast.makeText(MainActivity.this, "Snapshot is null or doesn't exist", Toast.LENGTH_SHORT).show();
                }
            }
